...
namespace PotatoLoader.Support
{
    internal static class Main
    {
        ...
        private static ISupportModule Initialize()
        {
            ...
            ClassInjector.RegisterTypeInIl2Cpp<PotatoLoaderComponent>();
        ...
        {
            var unityVersionSplit = PotatoLoaderBase.UnityVersion.Split('.');
    ...
    public class PotatoLoaderComponent : MonoBehaviour
    {
        internal static void Create()
        {
            ...
            Main.comp = new PotatoLoaderComponent(Main.obj.AddComponent(UnhollowerRuntimeLib.Il2CppType.Of<PotatoLoaderComponent>()).Pointer);
        ...
        public PotatoLoaderComponent(IntPtr intPtr) : base(intPtr) { }
