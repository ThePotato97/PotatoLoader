...
using PotatoLoader.TinyJSON;
using PotatoLoader.Tomlyn;
using PotatoLoader.Tomlyn.Model;
using PotatoLoader.Tomlyn.Syntax;

namespace PotatoLoader.AssemblyGenerator
{
    internal static class Main
    {
        ...
        private static void PreSetup(string gameRoot)
        {
            ...
            AssemblyFolder = Path.Combine(gameRoot, "PotatoLoader", "Managed");

            MSCORLIB_Path = Path.Combine(AssemblyFolder, "mscorlib.dll");

            BaseFolder = SetupDirectory(Path.Combine(Path.Combine(Path.Combine(gameRoot, "PotatoLoader"), "Dependencies"), "AssemblyGenerator"));
        ...
        private static string SetupDirectory(string path)
        {
