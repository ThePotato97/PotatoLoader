...
12. Create PotatoLoaderComponent after first scene load in Mono Games.  (Credits to knah :D)
13. Removed Launch Option --PotatoLoader.devpluginsonly.
14. Removed Launch Option --PotatoLoader.devmodsonly.
15. Added Launch Option --PotatoLoader.loadmodeplugins.
16. Added Launch Option --PotatoLoader.loadmodemods.
...
33. Deprecated PotatoLoader.Main use PotatoLoaderBase or MelonHandler instead.
...
41. Added Launch Option --PotatoLoader.consoleontop.  (Credits to trevtv :P)
...
18. Added Installer Check for Manual Zip (PotatoLoader.zip) next to the Installer exe.
...
24. Added Console Log Callbacks to PotatoLoader.Console.
...
8. UnityCrashHandler now terminates upon running with PotatoLoader.
...
12. Moved LightJson under its own Namespace as PotatoLoader.LightJson.
...
3. Added Launch Option "--PotatoLoader.agfvunhollower" that Forces the Assembly Generator to use a Specified Version of Il2CppAssemblyUnhollower.
...
12. Added better Legacy Version handling for "--PotatoLoader.agfvunhollower".
...
20. Forced Installer to reinstall the entire PotatoLoader folder.
...
25. Re-enabled Launch Option "--PotatoLoader.devpluginsonly".
...
29. Added Launch Option "--PotatoLoader.hidewarnings" that will Hide Warnings from Displaying in Normal Console.  (Debug Console ignores this Launch Option.)
...
32. Log Spam Shield will now Disable itself when PotatoLoader is using Debug Mode/Console.
33. Log Spam Shield has now been moved to the Native Logger.
34. Added Launch Option "--PotatoLoader.maxwarnings" for Setting the Max Amount of Warnings for the Log Spam Shield.  (Debug Console ignores this Launch Option, Default is 100, 0 to Disable.)
35. Added Launch Option "--PotatoLoader.maxerrors" for Setting the Max Amount of Errors for the Log Spam Shield.  (Debug Console ignores this Launch Option, Default is 100, 0 to Disable.)
...
45. Moved Tomlyn to its own Namespace under PotatoLoader.Tomlyn.
...
68. Added Launch Option "--PotatoLoader.chromium" to turn the Console Color Magenta.  (Thanks Chromium lol)
...
73. Changed Launch Option "--PotatoLoader.chromium" to "--PotatoLoader.magenta".
...
11. Fixed and Re-Enabled --PotatoLoader.hideconsole.
...
23. Small change to version.dll to Prevent Crashing when PotatoLoader.dll fails to load.
...
33. Added new Launch Option --PotatoLoader.devmodsonly.
...
44. Added Launch Option --PotatoLoader.agregenerate.
...
60. Fixed Issue with Zipped Mod Support when using --PotatoLoader.devmodsonly.
61. Added Launch Option --PotatoLoader.devpluginsonly.
62. Updated Il2CppAssemblyUnhollower Download to v0.4.7.  (Credits to knah :D)
63. Launch Option --PotatoLoader.quitfix has been changed to --quitfix.
64. Temporarily Disabled Plugins.
65. Temporarily Disabled Launch Option --PotatoLoader.devpluginsonly.
...
70. Fixed Issue with --PotatoLoader.devmodsonly.
...
6. Temporarily disabled --PotatoLoader.hideconsole.
...
7. Revised README.MD.
8. Changed the Hook and Unhook Internal Calls in PotatoLoader.Imports from internal to public to expose them and allow them to be used by Mods.
9. Revised CHANGELOG.MD.
10. Added Built-In QuitFix under the Launch Option --PotatoLoader.quitfix  (For Games like VRChat where the Process Hangs after telling it to Exit)
...
14. Added Support for Method Unstripping through Il2CppAssemblyUnhollower to PotatoLoader.AssemblyGenerator.
...
35. Removed Launch Option "--PotatoLoader.console".
36. Added Launch Option "--PotatoLoader.hideconsole" to Hide the Normal Console.
37. Cleaned up Il2Cpp Imports.
38. Cleaned up Mono Imports.
39. Revised Command Line Parsing.
40. Fixed Issue with the Log Cleaner deleting Logs that were not made by PotatoLoader.
41. Added Launch Option --PotatoLoader.maxlogs. Sets the Max Logs for the Log Cleaner. Set as 0 to Disable the Log Cleaner.
...
2. Cleaned up Hooking for PotatoLoader Internals.
...
35. Added --PotatoLoader.rainbow and --PotatoLoader.randomrainbow as Launch Options.  (As requested by Hordini :3)
36. Redesigned the Logging system to be unified between PotatoLoader and PotatoLoader.ModHandler.
37. Colorized Errors in both Consoles.
38. Added the ability for Mods to set a Color when Logging.
39. Fixed Issue with --PotatoLoader.rainbow and --PotatoLoader.randomrainbow not working when using --PotatoLoader.console.
40. Added Unload Functionality. Entirely unloads PotatoLoader.  (PotatoLoader::UNLOAD() or PotatoLoader.Imports.UNLOAD_PotatoLoader())
...
48. Added Assertion Manager to handle PotatoLoader Internals.
...
16. Fixed Issue that caused Unity Crash Handler to initialize PotatoLoader twice.
...
5. Fixed Issue with Audica crashing when trying to use PotatoLoader.
...
11. Added SteamVR and OculusVR Dependency DLLs to PotatoLoader/Managed.
...
PotatoLoader [DEBUG] & PotatoLoader.ModHandler [RELEASE]  =  Debug Console  
PotatoLoader [RELEASE] & PotatoLoader.ModHandler [DEBUG]  =  Normal Console  
PotatoLoader [DEBUG] & PotatoLoader.ModHandler [DEBUG]  =  Debug Console  
PotatoLoader [RELEASE] & PotatoLoader.ModHandler [RELEASE]  =  Left up to the Launch Options  
