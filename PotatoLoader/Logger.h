...
public:
	...
	static void DebugLog(const char* txt) { if (PotatoLoader::DebugMode) Log(txt); }
	static void DebugLog(const char* txt, ConsoleColor color) { if (PotatoLoader::DebugMode) Log(txt, color); };
	...
	static void DebugLogWarning(const char* txt) { if (PotatoLoader::DebugMode) LogWarning(txt); }
	static void DebugLogWarning(const char* namesection, const char* txt) { if (PotatoLoader::DebugMode) LogWarning(namesection, txt); }
	static void DebugLogWarning(std::string txt) { DebugLogWarning(txt.c_str()); }

	static void DebugLogError(const char* txt) { if (PotatoLoader::DebugMode) LogError(txt); }
	static void DebugLogError(const char* namesection, const char* txt) { if (PotatoLoader::DebugMode) LogError(namesection, txt); }
	...
	static void LogMelonCompatibility(PotatoLoader_Base::MelonCompatibility comp);
