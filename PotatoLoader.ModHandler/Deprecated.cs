...
{
    [Obsolete("Main is obsolete. Please use PotatoLoaderBase or MelonHandler instead.")]
    public static class Main
    {
        ...
        public static string GetUnityVersion() => PotatoLoaderBase.UnityVersion;
        public static string GetUserDataPath() => PotatoLoaderBase.UserDataPath;
