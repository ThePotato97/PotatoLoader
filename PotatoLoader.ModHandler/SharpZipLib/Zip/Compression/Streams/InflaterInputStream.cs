...
namespace PotatoLoader.ICSharpCode.SharpZipLib.Zip.Compression.Streams 
{
	...
	/// as the <see cref="PotatoLoader.ICSharpCode.SharpZipLib.GZip.GZipInputStream">GZipInputStream</see>.
	///
