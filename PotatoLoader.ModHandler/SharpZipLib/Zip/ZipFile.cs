...
using PotatoLoader.ICSharpCode.SharpZipLib.Encryption;
#endif

using PotatoLoader.ICSharpCode.SharpZipLib.Core;
using PotatoLoader.ICSharpCode.SharpZipLib.Checksums;
using PotatoLoader.ICSharpCode.SharpZipLib.Zip.Compression.Streams;
using PotatoLoader.ICSharpCode.SharpZipLib.Zip.Compression;

namespace PotatoLoader.ICSharpCode.SharpZipLib.Zip 
{
	...
	public class ZipFile : IEnumerable, IDisposable
	{
		...
		/// </exception>
		/// <exception cref="PotatoLoader.ICSharpCode.SharpZipLib.Zip.ZipException">
