...
{
    public static class PotatoLoaderBase
    {
        ...
        private static void AddUnityDebugLog()
        {
            ...
            SupportModule.UnityDebugLog("~   This Game has been MODIFIED using PotatoLoader. DO NOT report any issues to the Developers!   ~");
            SupportModule.UnityDebugLog("--------------------------------------------------------------------------------------------------");
        }
